		...
		this._initialize = function () {
			if (!this._initialized) {
				...
				if (!styled) {
					styled = true;
					styles = [
						'.jstree-grid-cell {vertical-align: top;margin-left:0;padding-left:7px;white-space: nowrap;}',
	          ...
	          '.jstree-grid-header-cell {white-space: nowrap;padding: 1px 3px 2px 5px;}',
						...
						'.jstree-grid-table {width: 100%;}',
						'.jstree-grid-width-auto {width:auto;}',
					];
